...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        self.last_channel = int(
            last_channel * width_mult
        ) if width_mult > 1.0 else last_channel

        self.features = [ConvBNReLU(3, input_channel, 3, 2)]
        ...
        self.features.append(ConvBNReLU(input_channel, last_channel, 1, 1, 0))
